			...
			<div class="site-content">
				...
				<div class="content-area py-1">
                    ...
                    <div class="box box-block bg-white">
                            ...
                            <button style="float:right; margin-bottom:10px;" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#myModal">Add Holiday</button>
                        <h5 class="mb-1">Holidays List</h5>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <form action="{{ route('holidays.store') }}" method="POST">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="holiday_date" class="form-control" placeholder="Holiday Date *">
              </div>
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-primary btn-lg btn-rounded" type="submit">Create Holiday</button>
