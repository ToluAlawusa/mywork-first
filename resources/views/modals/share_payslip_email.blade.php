<div class="modal fade" id="sendEmailFile" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        ...
        <form onsubmit="" method="POST" id="sendemailpayslip" enctype="multipart/form-data" class="form-material">
            @csrf
